...
class DemoListModel : public twig::ListModel<todo::Item> {
	public:
		DemoListModel() {
			items.push_back({});
		}
...
class DemoListView : public twig::ListView<todo::Item> {
	public:
		DemoListView(twig::ListModel<todo::Item> *model) : ListView(model) {}

	protected:
		void draw_row(
				const twig::Rectangle& bounds,
...
twig::ListModel<todo::Item> *list_model = new DemoListModel();
