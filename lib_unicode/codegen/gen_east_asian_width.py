...
def get_data():
    special_function ="""Unicode::EastAsianWidth Unicode::get_east_asian_width(Unicode::codepoint_t codepoint) {
return EastAsianWidthData::lookup(codepoint);
}"""
    ...
    ret = MegaTable(
            ...
            "X",
            "EastAsianWidthData",
            namespace_preamble = "using X = Unicode::EastAsianWidth;",
            global_postamble = special_function,
            out_of_bounds_value = "X::N",
